...
namespace HLog
{
static const std::string H_LOGGER_VERSION = "v0.3.1";
...
private:
    mout(){ }
    mout(const mout&) = delete; // Make this class non-copyable.
    mout(mout&&) = delete;
    mout& operator=(const mout&) = delete;
    mout& operator=(mout&&) = delete;

    static Logger _log(OutMode::To_Screen);
public:
};*/
